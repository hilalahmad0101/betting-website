        ...
        <div class="sidebar bg--dark">
            ...
            <div class="sidebar__inner">
                <div class="sidebar__logo">
                    <a href="https://script.viserlab.com/betlab/admin/dashboard" class="sidebar__main-logo"><img
                            src="https://script.viserlab.com/betlab/assets/images/logo_icon/logo.png"
                            alt="image"></a>
                </div>
                <div class="sidebar__menu-wrapper">
                    <ul class="sidebar__menu">
                        <li class="sidebar-menu-item active">
                            <a href="https://script.viserlab.com/betlab/admin/dashboard" class="nav-link ">
                        ...
                        <li class="sidebar__menu-header">BET SETUP</li>
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" class="">
                                <i class="menu-icon la la-spotify"></i>
                                <span class="menu-title">Sports Config</span>
                            </a>
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/categories"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/leagues" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Manage Leagues</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/teams" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/games/running"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Running Games</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/games/upcoming"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Upcoming Games</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/games/ended"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Ended Games</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/games" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">All Games</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar__menu-header">MANAGE BETS</li>
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" class="">
                                <i class="menu-icon las la-clipboard-list"></i>
                                <span class="menu-title">Manage Bets</span>
                                <span class="menu-badge menu-badge-level-one bg--warning ms-auto">
                                    <i class="fas fa-exclamation"></i>
                                </span>
                            </a>
                                ...
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/bet/pending"
                                            ...
                                            <span class="menu-badge bg--info ms-auto">514</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/bet/won" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Won Bets</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/bet/lose" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Lose Bets</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/bet/refunded"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Refunded Bets</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/bet/index" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">All Bets</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" class="">
                                <i class="menu-icon las la-clipboard-list"></i>
                                <span class="menu-title">Declare Outcomes</span>
                            </a>
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/match/market/pending-outcomes"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Pending Outcomes</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/match/market/declared-outcomes"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Declared Outcomes</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar__menu-header">MANAGE FINANCE</li>
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" class="">
                                ...
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/deposit/pending"
                                            ...
                                            <span class="menu-badge bg--info ms-auto">58</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/deposit/approved"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/deposit/successful"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/deposit/initiated"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/deposit/all"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                ...
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/withdraw/pending"
                                            ...
                                            <span class="menu-badge bg--info ms-auto">49</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/withdraw/approved"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar__menu-header">SUPPORT &amp; REPORT</li>
                        <li class="sidebar-menu-item sidebar-dropdown">
                            <a href="javascript:void(0)" class="">
                                ...
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/ticket/pending"
                                            ...
                                            <span class="menu-badge bg--info ms-auto">23</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/ticket/closed"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/ticket/answered"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/ticket" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/report/transaction"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/report/login/history"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/report/notification/history"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/report/referral/commission"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="https://script.viserlab.com/betlab/admin/system-setting" class="nav-link ">
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/system/info"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/system/server-info"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/system/optimize"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/betlab/admin/system/system-update"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item ">
                            <a href="https://script.viserlab.com/betlab/admin/request-report" class="nav-link ">
